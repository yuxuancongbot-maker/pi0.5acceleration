...
_CONFIGS = [
    ...
    #
    # π0.5 + L1 Flow fine-tuning on LIBERO-Plus (from local checkpoint)
    # Initialize from pi05_libero_l1_flow checkpoint (step 29999) instead of pi05_libero
    #
    TrainConfig(
        ...
        optimizer=_optimizer.AdamW(clip_gradient_norm=1.0),
        ema_decay=0.999,
        # Initialize from local pi05_libero_l1_flow checkpoint (step 29999)
